-- ==============================================
-- NEW EMPLOYEE ANALYTICS FUNCTIONS
-- Completely new functions with same structure
-- ==============================================

-- Function 1: Get user summary data (First Table) - NEW VERSION
...
-- Function 2: Get daily work breakdown (Second Table - Daily) - NEW VERSION
...
-- Function 3: Get weekly work breakdown (Second Table - Weekly) - NEW VERSION
...
-- Function 4: Get comprehensive employee analytics (Both tables combined) - NEW VERSION
CREATE OR REPLACE FUNCTION get_employee_complete_analytics(
    p_user_id BIGINT,
    p_start_date DATE DEFAULT NULL,
    p_end_date DATE DEFAULT NULL,
...
-- Function 5: Get all employees summary (for dashboard overview) - NEW VERSION
...
-- Function 6: Get employee productivity metrics - NEW VERSION
...
-- Function 7: Get employee time distribution by client - NEW VERSION
...
-- Function to get employee performance rating
...
-- ==============================================
-- INDEXES FOR PERFORMANCE - NEW VERSIONS
-- ==============================================

-- Create optimized indexes for new functions
CREATE INDEX IF NOT EXISTS idx_timesheets_user_date_new ON timesheets(user_id, date) WHERE date IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_timesheets_jobcode_new ON timesheets(jobcode_id) WHERE jobcode_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_timesheet_customfield_values_new ON timesheet_customfield_values(timesheet_id, customfield_id);
CREATE INDEX IF NOT EXISTS idx_jobcodes_name_new ON jobcodes(name) WHERE name IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_projects_jobcode_new ON projects(jobcode_id) WHERE jobcode_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_users_active_new ON users(id) WHERE active = true;

-- ==============================================
-- VIEWS FOR EASY ACCESS - NEW VERSIONS
-- ==============================================
...
-- ==============================================
-- EXAMPLE USAGE QUERIES - NEW VERSIONS
-- ==============================================
...
-- Example 5: Get comprehensive analytics for specific employee
-- SELECT * FROM get_employee_complete_analytics(503759, '2024-01-01', '2024-12-31', 'daily');

-- Example 6: Get productivity metrics for specific employee
...
-- Example 8: Get performance rating for specific employee
-- SELECT get_employee_performance_rating(503759, '2024-01-01', '2024-12-31');

-- Example 9: Calculate working days
